...
-- Start sequence
push_start_command(dt,		{message = _("TAIKUNON F/A-18C AUTOSTART SEQUENCE V1 AA IS RUNNING"),													message_timeout = start_sequence_time})
...
push_start_command(dt,		{message = _("UFC: TCN - ON"),																	message_timeout = dt_mto})
push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwTCN,						value = 1.0})
push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwTCN,						value = 0.0})
push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 1.0})
push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 0.0})

push_start_command(dt,		{message = _("UFC: ILS - ON"),																	message_timeout = dt_mto})
push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwILS,						value = 1.0})
push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwILS,						value = 0.0})

push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 1.0})
push_start_command(dt,		{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 0.0})

push_start_command(dt,		{message = _("UFC: D/L - ON"),																	message_timeout = dt_mto})
...
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_13,					value = 1.0}) -- SA
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_13,					value = 0.0}) -- SA

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_5,						value = 1.0}) -- Sensor
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_5,						value = 0.0}) -- Sensor

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_7,						value = 1.0}) -- RWR All
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_7,						value = 0.0}) -- RWR All

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 1.0}) -- FRIEND NO ID
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 0.0}) -- FRIEND NO ID

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 1.0}) -- FRIEND RWR ID
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 0.0}) -- FRIEND RWR ID

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_10,					value = 1.0}) -- SA
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_10,					value = 0.0}) -- SA

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 1.0}) -- Set Scale 20
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 0.0}) -- Set Scale 20

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 1.0}) -- Set Scale 10
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 0.0}) -- Set Scale 10

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 1.0}) -- Set scale 5
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 0.0}) -- Set scale 5

push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 1.0}) -- Set Scale 160
push_start_command(dt,		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,						value = 0.0}) -- Set Scale 160
...
push_start_command(dt,		{device = devices.MDI_LEFT,			action = MDI_commands.MDI_PB_6,								value = 1.0}) -- SIZE
push_start_command(dt,		{device = devices.MDI_LEFT,			action = MDI_commands.MDI_PB_6,								value = 0.0}) -- SIZE

push_start_command(dt,		{device = devices.MDI_LEFT,			action = MDI_commands.MDI_PB_6,								value = 1.0}) -- SML
push_start_command(dt,		{device = devices.MDI_LEFT,			action = MDI_commands.MDI_PB_6,								value = 0.0}) -- SML

push_start_command(dt,		{device = devices.MDI_LEFT,			action = MDI_commands.MDI_PB_7,								value = 1.0}) -- RCS
push_start_command(dt,		{device = devices.MDI_LEFT,			action = MDI_commands.MDI_PB_7,								value = 0.0}) -- RCS
...
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_19,						value = 1.0}) -- 40°
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_19,						value = 0.0}) -- 40°

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_6,							value = 1.0}) -- 4B
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_6,							value = 0.0}) -- 4B

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 1.0}) -- MED
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 0.0}) -- MED

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 1.0}) -- HI
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 0.0}) -- HI
...
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_16,						value = 1.0}) -- Data
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_16,						value = 0.0}) -- Data

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_10,						value = 1.0}) -- 8
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_10,						value = 0.0}) -- 8

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_10,						value = 1.0}) -- 16
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_10,						value = 0.0}) -- 16

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_10,						value = 1.0}) -- 32
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_10,						value = 0.0}) -- 32
...
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_12,						value = 1.0}) -- 20 NM
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_12,						value = 0.0}) -- 20 NM

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_12,						value = 1.0}) -- 10 NM
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_12,						value = 0.0}) -- 10 NM

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_19,						value = 1.0}) -- 140°
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_19,						value = 0.0}) -- 140°

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_19,						value = 1.0}) -- 20°
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_19,						value = 0.0}) -- 20°

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_6,							value = 1.0}) -- 6B
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_6,							value = 0.0}) -- 6B
...
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 1.0}) -- AZZEL
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 0.0}) -- AZZEL

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 1.0}) -- AUTO INI
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_1,							value = 0.0}) -- AUTO INI

-- HMD - MIDS SETUP 100
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_18,						value = 1.0}) -- MENU TAC
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_18,						value = 0.0}) -- MENU TAC

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_18,						value = 1.0}) -- MENU SUPT
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_18,						value = 0.0}) -- MENU SUPT

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_3,							value = 1.0}) -- HMD
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_3,							value = 0.0}) -- HMD

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_17,						value = 1.0}) -- MIDS SETUP
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_17,						value = 0.0}) -- MIDS SETUP

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 40
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 40

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 45
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 45

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 50
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 50

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 55
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 55

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 60
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 60

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 65
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 65

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 70
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 70

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 75
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 75

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 80
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 80

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 85
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 85

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 90
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 90

push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 1.0}) -- 95
push_start_command(dt,		{device = devices.MDI_RIGHT,			action = MDI_commands.MDI_PB_14,						value = 0.0}) -- 95
